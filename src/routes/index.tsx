  ...
  return (
    <main class="min-h-screen bg-[#F5F4EF] text-[#393939] font-sans p-6 md:p-12 flex flex-col items-center">
      <div class="w-full max-w-6xl my-12 font-serif">
        <div class="grid grid-cols-3 border-b border-[#D8D4CF] pb-2 text-[#6B6255] uppercase tracking-wider text-xs">
          <div>Test Case</div>
        ...
        <div class="divide-y divide-[#D8D4CF]">
          ...
          <div class="grid grid-cols-3 py-4 items-center">
            ...
            <div class="text-center text-[#6B6255]">Paired t-test</div>
        ...
        <nav class="mt-8 flex flex-col gap-2">
          <span class="text-[#6B6255] uppercase tracking-wider text-[10px] font-sans">Other tests</span>
      ...
      <section id="mann-whitney-u" class="w-full flex flex-col items-center space-y-4 mt-16 mb-24 scroll-mt-24">
        <div class="max-w-6xl w-full space-y-2 text-left">
          <h2 class="text-2xl md:text-3xl font-serif text-[#2D2D2D] font-medium">
            Mann-Whitney U-test
          </h2>
